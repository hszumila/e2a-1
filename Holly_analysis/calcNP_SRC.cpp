...
const double mmiss_nomCut_n = 1.15;
const double pmissSRC_nomCut_n = 0.36;
...
int main(){
  ...
  tgt_min = vtx_min_C; tgt_max = vtx_max_C; tgt_Z = 6; tgt_A = 12; tgt_M = M12C;
  ...
  TFile *f_3n = new TFile("../../../data/19jun20/skim_C12_n_Jun20.root");
