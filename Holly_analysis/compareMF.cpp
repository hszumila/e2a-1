...
double f_delta_p(double p){
  ...
  //2.2,4.4 GeV 3He:
  double ec_extr_res = 0.091479;//0.098159;//0.098159;//-0.09;//0967682;
  double dt = 0.3292;//0.3532;//0.3532;//0.392319;//0.625                 //ec_time_res;
...
int main(){
  ...
  TFile *fout = new TFile("output/out_MF.root","RECREATE");
