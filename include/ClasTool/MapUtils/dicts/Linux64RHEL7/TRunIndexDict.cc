//
// File generated by /u/apps/root/5.34.36/root/bin/rootcint at Fri Feb 24 17:40:01 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::TRunIndex*)
   {
      ::TRunIndex *ptr = 0;
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TRunIndex", ::TRunIndex::Class_Version(), "./TRunIndex.h", 19,
                  typeid(::TRunIndex), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::TRunIndex*)
   {
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TRunIndex*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TRunIndex::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TRunIndex*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TRunIndex::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TRunIndex*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TRunIndex::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TRunIndex*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::TRunIndex

/********************************************************
* dicts/Linux64RHEL7/TRunIndexDict.cc
...
/* TRunIndex */
static int G__TRunIndexDict_220_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TRunIndex* p = NULL;
...
static int G__TRunIndexDict_220_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TRunIndex* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 8
...
static int G__TRunIndexDict_220_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TRunIndexDict_220_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TRunIndexDict_220_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TRunIndex::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TRunIndex::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TRunIndex::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TRunIndexDict_220_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TRunIndexDict_220_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TRunIndex::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TRunIndex::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TRunIndex::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TRunIndexDict_220_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TRunIndexDict_220_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TRunIndexDict_220_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TRunIndexDict_220_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTRunIndex(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TRunIndexDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTRunIndex(void) {
   ...
   G__memfunc_setup("TRunIndex",897,G__TRunIndexDict_220_0_1, 105, G__get_linked_tagnum(&G__TRunIndexDictLN_TRunIndex), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TRunIndex",897,G__TRunIndexDict_220_0_2, 105, G__get_linked_tagnum(&G__TRunIndexDictLN_TRunIndex), -1, 0, 8, 1, 1, 0, 
...
"C - - 10 - fpTime C - - 10 - fpComment", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Set",300,G__TRunIndexDict_220_0_3, 121, -1, -1, 0, 8, 1, 1, 0, 
"i - 'Int_t' 0 - fpRunIndexId i - 'Int_t' 0 - fpMinRun "
"i - 'Int_t' 0 - fpMaxRun i - 'Int_t' 0 - fpItemId "
"i - 'Int_t' 0 - fpItemValueId C - - 10 - fpOfficer "
"C - - 10 - fpTime C - - 10 - fpComment", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__TRunIndexDict_220_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TRunIndexDict_220_0_5, 85, G__get_linked_tagnum(&G__TRunIndexDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TRunIndex::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TRunIndexDict_220_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TRunIndex::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TRunIndexDict_220_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TRunIndex::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TRunIndexDict_220_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TRunIndex::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TRunIndexDict_220_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TRunIndexDict_220_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TRunIndex::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TRunIndexDict_220_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TRunIndex::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TRunIndexDict_220_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TRunIndex::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TRunIndexDict_220_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TRunIndex::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TRunIndex", 897, G__TRunIndexDict_220_0_17, (int) ('i'), G__get_linked_tagnum(&G__TRunIndexDictLN_TRunIndex), -1, 0, 1, 1, 1, 0, "u 'TRunIndex' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TRunIndex", 1023, G__TRunIndexDict_220_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TRunIndexDict_220_0_19, (int) ('u'), G__get_linked_tagnum(&G__TRunIndexDictLN_TRunIndex), -1, 1, 1, 1, 1, 0, "u 'TRunIndex' - 11 - -", (char*) NULL, (void*) NULL, 0);
