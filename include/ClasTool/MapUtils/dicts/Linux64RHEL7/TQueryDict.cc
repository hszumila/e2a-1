//
// File generated by /u/apps/root/5.34.36/root/bin/rootcint at Fri Feb 24 17:40:00 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::TQuery*)
   {
      ::TQuery *ptr = 0;
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TQuery", ::TQuery::Class_Version(), "./TQuery.h", 30,
                  typeid(::TQuery), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::TQuery*)
   {
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TQuery*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TQuery::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TQuery*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TQuery::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TQuery*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TQuery::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TQuery*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::TQuery

/********************************************************
* dicts/Linux64RHEL7/TQueryDict.cc
...
/* TQuery */
static int G__TQueryDict_226_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TQuery* p = NULL;
...
static int G__TQueryDict_226_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) ((TQuery*) G__getstructoffset())->Data());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TQueryDict_226_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TQueryDict_226_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__TQueryDict_226_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__TQueryDict_226_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__TQueryDict_226_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G__TQueryDict_226_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G__TQueryDict_226_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TQuery::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TQuery::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TQuery::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      TQuery::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__TQueryDict_226_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TQueryDict_226_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TQuery::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TQuery::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TQuery::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TQueryDict_226_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TQueryDict_226_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TQueryDict_226_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TQueryDict_226_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTQuery(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TQueryDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTQuery(void) {
   ...
   G__memfunc_setup("TQuery",618,G__TQueryDict_226_0_1, 105, G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Data",378,G__TQueryDict_226_0_2, 67, -1, -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Preview",738,G__TQueryDict_226_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Reset",515,G__TQueryDict_226_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator<<",996,G__TQueryDict_226_0_5, 117, G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 1, 1, 1, 1, 0, "i - - 0 - x_int", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator<<",996,G__TQueryDict_226_0_6, 117, G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 1, 1, 1, 1, 0, "f - - 0 - x_float", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator<<",996,G__TQueryDict_226_0_7, 117, G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 1, 1, 1, 1, 0, "C - - 10 - n_char", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FloatOf",683,G__TQueryDict_226_0_8, 102, -1, -1, 0, 1, 1, 1, 0, "C - - 10 '\"0.0\"' chr_float", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IntOf",480,G__TQueryDict_226_0_9, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "C - - 10 '\"0\"' chr_int", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TQueryDict_226_0_10, 85, G__get_linked_tagnum(&G__TQueryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TQuery::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TQueryDict_226_0_11, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TQuery::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TQueryDict_226_0_12, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TQuery::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TQueryDict_226_0_13, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TQuery::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TQueryDict_226_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TQueryDict_226_0_18, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TQuery::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TQueryDict_226_0_19, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TQuery::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TQueryDict_226_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TQuery::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TQueryDict_226_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TQuery::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TQuery", 618, G__TQueryDict_226_0_22, (int) ('i'), G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 0, 1, 1, 1, 0, "u 'TQuery' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TQuery", 744, G__TQueryDict_226_0_23, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TQueryDict_226_0_24, (int) ('u'), G__get_linked_tagnum(&G__TQueryDictLN_TQuery), -1, 1, 1, 1, 1, 0, "u 'TQuery' - 11 - -", (char*) NULL, (void*) NULL, 0);
