//
// File generated by /u/apps/root/5.34.13/root/bin/rootcint at Fri Jan 20 19:15:48 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME dictsdILinux64RHEL6dITTRGSClassDict
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TTRGSClass*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TTRGSClass", ::TTRGSClass::Class_Version(), "./TTRGSClass.h", 20,
                  typeid(::TTRGSClass), DefineBehavior(ptr, ptr),
...
TClass *TTRGSClass::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TTRGSClass*)0x0)->GetClass();
   return fgIsA;
}
...
/********************************************************
* dicts/Linux64RHEL6/TTRGSClassDict.cc
...
/* TTRGSClass */
static int G__TTRGSClassDict_183_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TTRGSClass* p = NULL;
...
static int G__TTRGSClassDict_183_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TTRGSClass* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__TTRGSClassDict_183_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TTRGSClassDict_183_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TTRGSClass::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TTRGSClass::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TTRGSClass::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TTRGSClassDict_183_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TTRGSClassDict_183_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TTRGSClass::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TTRGSClass::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TTRGSClass::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TTRGSClassDict_183_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TTRGSClassDict_183_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TTRGSClassDict_183_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TTRGSClassDict_183_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTTRGSClass(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TTRGSClassDictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTTRGSClass(void) {
   ...
   G__memfunc_setup("TTRGSClass",906,G__TTRGSClassDict_183_0_1, 105, G__get_linked_tagnum(&G__TTRGSClassDictLN_TTRGSClass), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TTRGSClass",906,G__TTRGSClassDict_183_0_2, 105, G__get_linked_tagnum(&G__TTRGSClassDictLN_TTRGSClass), -1, 0, 1, 1, 1, 0, "U 'TTRGSClass' - 0 - TmpTRGS", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__TTRGSClassDict_183_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TTRGSClassDict_183_0_4, 85, G__get_linked_tagnum(&G__TTRGSClassDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TTRGSClass::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TTRGSClassDict_183_0_5, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TTRGSClass::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TTRGSClassDict_183_0_6, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TTRGSClass::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TTRGSClassDict_183_0_7, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TTRGSClass::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TTRGSClassDict_183_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TTRGSClassDict_183_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TTRGSClass::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TTRGSClassDict_183_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TTRGSClass::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TTRGSClassDict_183_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TTRGSClass::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TTRGSClassDict_183_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TTRGSClass::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TTRGSClass", 906, G__TTRGSClassDict_183_0_16, (int) ('i'), G__get_linked_tagnum(&G__TTRGSClassDictLN_TTRGSClass), -1, 0, 1, 1, 1, 0, "u 'TTRGSClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TTRGSClass", 1032, G__TTRGSClassDict_183_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TTRGSClassDict_183_0_18, (int) ('u'), G__get_linked_tagnum(&G__TTRGSClassDictLN_TTRGSClass), -1, 1, 1, 1, 1, 0, "u 'TTRGSClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
