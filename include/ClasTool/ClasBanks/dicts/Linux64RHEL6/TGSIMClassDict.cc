//
// File generated by /u/apps/root/5.34.13/root/bin/rootcint at Fri Jan 20 19:15:28 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME dictsdILinux64RHEL6dITGSIMClassDict
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TGSIMClass*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TGSIMClass", ::TGSIMClass::Class_Version(), "./TGSIMClass.h", 80,
                  typeid(::TGSIMClass), DefineBehavior(ptr, ptr),
...
TClass *TGSIMClass::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGSIMClass*)0x0)->GetClass();
   return fgIsA;
}
...
/********************************************************
* dicts/Linux64RHEL6/TGSIMClassDict.cc
...
/* TGSIMClass */
static int G__TGSIMClassDict_237_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TGSIMClass* p = NULL;
...
static int G__TGSIMClassDict_237_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TGSIMClass* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__TGSIMClassDict_237_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TGSIMClass::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TGSIMClass::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TGSIMClass::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TGSIMClassDict_237_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TGSIMClassDict_237_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TGSIMClass::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TGSIMClass::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TGSIMClass::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TGSIMClassDict_237_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TGSIMClassDict_237_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TGSIMClassDict_237_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TGSIMClassDict_237_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTGSIMClass(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TGSIMClassDictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTGSIMClass(void) {
   ...
   G__memfunc_setup("TGSIMClass",890,G__TGSIMClassDict_237_0_1, 105, G__get_linked_tagnum(&G__TGSIMClassDictLN_TGSIMClass), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TGSIMClass",890,G__TGSIMClassDict_237_0_2, 105, G__get_linked_tagnum(&G__TGSIMClassDictLN_TGSIMClass), -1, 0, 1, 1, 1, 0, "U 'TGSIMClass' - 0 - TmpEVNT", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("Class",502,G__TGSIMClassDict_237_0_12, 85, G__get_linked_tagnum(&G__TGSIMClassDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TGSIMClass::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TGSIMClassDict_237_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TGSIMClass::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TGSIMClassDict_237_0_14, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TGSIMClass::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TGSIMClassDict_237_0_15, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TGSIMClass::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TGSIMClassDict_237_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TGSIMClassDict_237_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TGSIMClass::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TGSIMClassDict_237_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TGSIMClass::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TGSIMClassDict_237_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TGSIMClass::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TGSIMClassDict_237_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TGSIMClass::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TGSIMClass", 890, G__TGSIMClassDict_237_0_24, (int) ('i'), G__get_linked_tagnum(&G__TGSIMClassDictLN_TGSIMClass), -1, 0, 1, 1, 1, 0, "u 'TGSIMClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TGSIMClass", 1016, G__TGSIMClassDict_237_0_25, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TGSIMClassDict_237_0_26, (int) ('u'), G__get_linked_tagnum(&G__TGSIMClassDictLN_TGSIMClass), -1, 1, 1, 1, 1, 0, "u 'TGSIMClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
