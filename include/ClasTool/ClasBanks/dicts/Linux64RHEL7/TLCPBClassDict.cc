//
// File generated by /u/apps/root/5.34.36/root/bin/rootcint at Fri Feb 24 17:38:26 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::TLCPBClass*)
   {
      ::TLCPBClass *ptr = 0;
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TLCPBClass", ::TLCPBClass::Class_Version(), "./TLCPBClass.h", 19,
                  typeid(::TLCPBClass), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::TLCPBClass*)
   {
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TLCPBClass*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TLCPBClass::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::TLCPBClass*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TLCPBClass::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TLCPBClass*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TLCPBClass::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::TLCPBClass*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::TLCPBClass

/********************************************************
* dicts/Linux64RHEL7/TLCPBClassDict.cc
...
/* TLCPBClass */
static int G__TLCPBClassDict_184_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TLCPBClass* p = NULL;
...
static int G__TLCPBClassDict_184_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TLCPBClass* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__TLCPBClassDict_184_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TLCPBClassDict_184_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TLCPBClass::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TLCPBClass::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TLCPBClass::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TLCPBClassDict_184_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TLCPBClassDict_184_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TLCPBClass::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TLCPBClass::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TLCPBClass::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TLCPBClassDict_184_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TLCPBClassDict_184_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TLCPBClassDict_184_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TLCPBClassDict_184_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTLCPBClass(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TLCPBClassDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTLCPBClass(void) {
   ...
   G__memfunc_setup("TLCPBClass",875,G__TLCPBClassDict_184_0_1, 105, G__get_linked_tagnum(&G__TLCPBClassDictLN_TLCPBClass), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TLCPBClass",875,G__TLCPBClassDict_184_0_2, 105, G__get_linked_tagnum(&G__TLCPBClassDictLN_TLCPBClass), -1, 0, 1, 1, 1, 0, "U 'TLCPBClass' - 0 - TmpLCPB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__TLCPBClassDict_184_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TLCPBClassDict_184_0_4, 85, G__get_linked_tagnum(&G__TLCPBClassDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TLCPBClass::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TLCPBClassDict_184_0_5, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TLCPBClass::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TLCPBClassDict_184_0_6, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TLCPBClass::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TLCPBClassDict_184_0_7, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TLCPBClass::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TLCPBClassDict_184_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TLCPBClassDict_184_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TLCPBClass::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TLCPBClassDict_184_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TLCPBClass::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TLCPBClassDict_184_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TLCPBClass::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TLCPBClassDict_184_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TLCPBClass::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TLCPBClass", 875, G__TLCPBClassDict_184_0_16, (int) ('i'), G__get_linked_tagnum(&G__TLCPBClassDictLN_TLCPBClass), -1, 0, 1, 1, 1, 0, "u 'TLCPBClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TLCPBClass", 1001, G__TLCPBClassDict_184_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TLCPBClassDict_184_0_18, (int) ('u'), G__get_linked_tagnum(&G__TLCPBClassDictLN_TLCPBClass), -1, 1, 1, 1, 1, 0, "u 'TLCPBClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
