//
// File generated by /u/apps/root/5.34.13/root/bin/rootcint at Fri Jan 20 19:16:18 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME dictsdILinux64RHEL6dITCounterDict
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TCounter*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TCounter", ::TCounter::Class_Version(), "./TCounter.h", 29,
                  typeid(::TCounter), DefineBehavior(ptr, ptr),
...
TClass *TCounter::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TCounter*)0x0)->GetClass();
   return fgIsA;
}
...
/********************************************************
* dicts/Linux64RHEL6/TCounterDict.cc
...
/* TCounter */
static int G__TCounterDict_261_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TCounter* p = NULL;
...
static int G__TCounterDict_261_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TCounter* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__TCounterDict_261_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) ((TCounter*) G__getstructoffset())->GetTitle());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((TCounter*) G__getstructoffset())->Test((Bool_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((TCounter*) G__getstructoffset())->True());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((TCounter*) G__getstructoffset())->False());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TCounter*) G__getstructoffset())->GetTrues());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TCounter*) G__getstructoffset())->GetFalse());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((TCounter*) G__getstructoffset())->IsEqual((TObject*) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TCounter::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCounter::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TCounter::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      TCounter::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__TCounterDict_261_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCounter::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TCounter::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCounter::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TCounterDict_261_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TCounterDict_261_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__TCounterDict_261_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TCounterDict_261_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarTCounter(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__TCounterDictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTCounter(void) {
   ...
   G__memfunc_setup("TCounter",820,G__TCounterDict_261_0_1, 105, G__get_linked_tagnum(&G__TCounterDictLN_TCounter), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TCounter",820,G__TCounterDict_261_0_2, 105, G__get_linked_tagnum(&G__TCounterDictLN_TCounter), -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetTitle",814,G__TCounterDict_261_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTitle",802,G__TCounterDict_261_0_4, 67, -1, -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Reset",515,G__TCounterDict_261_0_5, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Test",416,G__TCounterDict_261_0_6, 103, -1, G__defined_typename("Bool_t"), 0, 1, 1, 1, 0, "g - 'Bool_t' 0 - test", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("True",416,G__TCounterDict_261_0_7, 103, -1, G__defined_typename("Bool_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("False",491,G__TCounterDict_261_0_8, 103, -1, G__defined_typename("Bool_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTrues",819,G__TCounterDict_261_0_9, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetFalse",779,G__TCounterDict_261_0_10, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetTrues",831,G__TCounterDict_261_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - count", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetFalse",791,G__TCounterDict_261_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - count", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Browse",626,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "U 'TBrowser' - 0 - b", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__TCounterDict_261_0_14, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IsEqual",692,G__TCounterDict_261_0_15, 103, -1, G__defined_typename("Bool_t"), 0, 1, 1, 1, 0, "U 'TObject' - 0 - obj", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TCounterDict_261_0_16, 85, G__get_linked_tagnum(&G__TCounterDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TCounter::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TCounterDict_261_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCounter::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TCounterDict_261_0_18, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TCounter::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TCounterDict_261_0_19, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TCounter::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TCounterDict_261_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TCounterDict_261_0_24, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCounter::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TCounterDict_261_0_25, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCounter::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TCounterDict_261_0_26, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCounter::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TCounterDict_261_0_27, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCounter::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TCounter", 820, G__TCounterDict_261_0_28, (int) ('i'), G__get_linked_tagnum(&G__TCounterDictLN_TCounter), -1, 0, 1, 1, 1, 0, "u 'TCounter' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TCounter", 946, G__TCounterDict_261_0_29, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TCounterDict_261_0_30, (int) ('u'), G__get_linked_tagnum(&G__TCounterDictLN_TCounter), -1, 1, 1, 1, 1, 0, "u 'TCounter' - 11 - -", (char*) NULL, (void*) NULL, 0);
